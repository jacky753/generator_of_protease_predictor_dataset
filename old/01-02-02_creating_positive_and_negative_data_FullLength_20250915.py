...
def main():
    ...
    create_posi_nega_dataset(merops_code_mece, cur, error_list)
...
def create_posi_nega_dataset(merops_code_mece, cur, error_list):
    #count = 0
    protease_turn = 0
    #substrate_turn = 0
    #error_list = ["DAA158"]
    for protease in merops_code_mece:
        ...
        df_cleave_pattern = create_posi_dataset(protease, list_subs, df_cleave_pattern, protease_turn, error_list)

        #negative_dataの元となる配列データを作成する
        df_negative_pattern = create_nega_dataset(protease, list_subs, df_cleave_pattern, protease_turn, error_list) 
    print("END")
    #return df_cleave_pattern, df_negative_pattern

def create_posi_dataset(protease, list_subs, df_cleave_pattern, protease_turn, error_list):
...
def create_nega_dataset(protease, list_subs, df_negative_pattern, protease_turn, error_list):
    for i in range(len(list_subs)):
